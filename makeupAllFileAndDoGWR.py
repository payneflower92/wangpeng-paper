...
nvdiRoot=os.path.join(rootDir,"")
demRoot=os.path.join(rootDir,"")
rgsRoot=os.path.join(rootDir,"")
trmmRoot=os.path.join(rootDir,"TRMMtifATPK")



newOutDir=r'C:\Users\crawl\Desktop\workForWP\wangpeng-master-thesis\reorganizedRawData\NDVI_1KM'
mirrorDic = dict()
